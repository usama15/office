...
import icon2 from '../assets/Untitled-1 0.2.png'
import icon3 from '../assets/Untitled-1 0.3.png'
import icon4 from '../assets/Untitled-1 0.4.png'
import icon5 from '../assets/Untitled-1 0.5.png'

const Navbar = () => {
    return (
        <div className="main-wrapper nav1">
